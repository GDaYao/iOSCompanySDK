...
@interface NPTSDKNetworkAccessibity(){
...
@implementation NPTSDKNetworkAccessibity
...
+ (NPTSDKNetworkAccessibity *)sharedInstance {
    static NPTSDKNetworkAccessibity * instance = nil;
...
static void ReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info) {
    NPTSDKNetworkAccessibity *networkAccessibity = (__bridge NPTSDKNetworkAccessibity *)info;
    if (![networkAccessibity isKindOfClass: [NPTSDKNetworkAccessibity class]]) {
        return;
    }
...
- (void)notiWithAccessibleState:(ZYNetworkAccessibleState)state {
    ...
    if (state != _previousState) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:nptNetworkAccessibityChangedNotification object:nil];
